...
namespace Repo.Context
{
    public partial class AppDBContext : DbContext
    {
        ...
        public AppDBContext() : base("mssqldb")
        {
            Database.Log = sql =>
            {
                Debug.WriteLine(sql);
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            var thisType = typeof(AppDBContext);
    ...
    public class DatabaseConfiguration : DbMigrationsConfiguration<AppDBContext>
    {
    ...
    public class DatabaseInitializer : MigrateDatabaseToLatestVersion<AppDBContext, DatabaseConfiguration>
    {
